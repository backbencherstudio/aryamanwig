...
export class ProfileController {
  ...
  @Get("me/dashboard")
  async getMyDashboard(@Req() req: any, @Query() query: PaginationDto) {
  ...
  @Get("client/:id")
  async Client(@Req() req: any, @Param("id") id: string) {
    return this.profileService.Client(id);
  }

  // cliet review list
  @Get("client-with-rating/:id")
  async getClientReviews(@Req() req: any, @Param("id") id: string) {
