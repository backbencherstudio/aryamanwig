...
export class ProductsController {
  ...
  getAllProductsForUser(@Req() req: any, @Query() query: PaginationDto) {
    const user = req.user.userId;
  ...
  async findAllProductsInCategory(
    ...
    const user = req.user.userId;
    return this.productsService.findAllProductsInCategory(
      id,
      user,
      paginationDto,
    );
  ...
  async findLatestProductsInCategory(
    ...
    const user = req.user.userId;
    return this.productsService.findLatestProductsInCategory(
      id,
      user,
      paginationDto,
    );
  ...
  async findOldestProductsInCategory(
    ...
    const user = req.user.userId;
    return this.productsService.findOldestProductsInCategory(
      id,
      user,
      paginationDto,
    );
