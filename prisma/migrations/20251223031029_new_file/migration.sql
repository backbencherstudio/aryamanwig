...
-- CreateEnum
CREATE TYPE "BoostPaymentStatus" AS ENUM ('PENDING', 'PAID', 'FAILED');
...
-- CreateEnum
CREATE TYPE "DisposalStatus" AS ENUM ('PENDING', 'CONFIRMED', 'COMPLETED', 'PICKUP', 'CANCELLED', 'PENALTY');
...
CREATE TABLE "users" (
    ...
    "gender" TEXT,
    "date_of_birth" DATE,
    "avaliable_balance" DECIMAL(10,2),
    "fcm_token" TEXT,
    "device_type" TEXT,
    "googleId" TEXT,
    "apple_id" TEXT,
...
CREATE TABLE "products" (
    ...
    "photo" TEXT[],
    "product_item_size" "ProductItemSize" NOT NULL DEFAULT 'SMALL',
    "location" TEXT,
    "size" TEXT,
    "color" TEXT,
    "time" TIMESTAMP(3),
...
-- AddForeignKey
ALTER TABLE "user_earnings" ADD CONSTRAINT "user_earnings_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_earnings" ADD CONSTRAINT "user_earnings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
